...
function Teachers() {
  ...
  let loadData = async () => {
    ...
    let teachers = await axios.get(
      "https://628209e19fac04c6540df59f.mockapi.io/kirubaharan"
    );
  ...
  let teacherDelete = async (id) => {
    try {
      ...
      if (ask) {
        await axios.delete(
          `https://628209e19fac04c6540df59f.mockapi.io/kirubaharan/${id}`
        );
      }
  ...
  return (
    <div className="container">
      <div className="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        >
          <FontAwesomeIcon
            className="fal mx-2 fa-sm text-white-50"
            icon={faUsers}
          />
          Create Teacher
        </Link>
                    ...
                    return (
                      <tr>
                        ...
                        <td>
                          ...
                          <Link
                            to={`/portal/teachers/edit/${teacher.id}`}
